...
const defaultMeta = {
  title: 'Parlor Points Simular | DeGods',
  siteName: 'Parlor Points Simular | DeGods',
  description: 'Parlor Points Simular | DeGods',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://degods-parlor-simulator.vercel.app',
  type: 'website',
  robots: 'follow, index',
  /**
    ...
    <Head>
      ...
      {meta.date && (
        <>
          ...
          <meta name='author' property='article:author' content='ttu' />
        </>
      )}
